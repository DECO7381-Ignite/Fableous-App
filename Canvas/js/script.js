...
let canvasBoxWidth = document.getElementById("canvas-box").offsetWidth;
let canvasBoxHeight = document.getElementById("canvas-box").offsetHeight;

canvas.width = canvasBoxWidth;
canvas.height = canvasBoxHeight;
